    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (res.success) {
                ...
                // $("#name required").text(res.message);
                // $("#invalid name").text(res.message);
                // $("#email required").text(res.message);
                // $("#email invalid").text(res.message);
                // $("#number required").text(res.message);
                // $("#invalid number").text(res.message);
            }
        }
